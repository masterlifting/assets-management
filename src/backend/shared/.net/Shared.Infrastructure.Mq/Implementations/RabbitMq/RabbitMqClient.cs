...
using Shared.Infrastructure.Mq.Implementations.RabbitMq.Settings;

namespace Shared.Infrastructure.Mq.Implementations.RabbitMq;
...
public sealed class RabbitMqClient
{
    ...
    public IModel CreateModel()
    {
        ...
        _logger.LogTrace(_initiator, Constants.Connect, Constants.Start);

        using var connection = _connectionFactory.CreateConnection();
        var model = connection.CreateModel();

        _logger.LogTrace(_initiator, Constants.Connect, Constants.Success);
    ...
    private void Register()
    {
        ...
        _logger.LogTrace(_initiator, "Register models", Constants.Start);
        ...
        _logger.LogTrace(_initiator, "Register models", Constants.Success);
    }
