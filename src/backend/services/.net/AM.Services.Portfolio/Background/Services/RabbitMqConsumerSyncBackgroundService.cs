...
public class RabbitMqConsumerSyncBackgroundService : MqConsumerBackgroundService<RabbitMqConsumerSettings>
{
    protected RabbitMqConsumerSyncBackgroundService(
        IServiceScopeFactory scopeFactory
        , IOptionsMonitor<IMqConsumerSection<RabbitMqConsumerSettings>> options
        , ILogger<RabbitMqConsumerSyncBackgroundService> logger
        , IMqConsumer consumer) : base(options, logger, consumer, new RabbitMqConsumerSyncBackgroundTask(scopeFactory))
    {
    }
}