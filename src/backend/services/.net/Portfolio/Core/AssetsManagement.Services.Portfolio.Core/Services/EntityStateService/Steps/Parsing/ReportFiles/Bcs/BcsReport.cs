...
using AM.Services.Portfolio.Core.Services.EntityStateService.Steps.Parsing.ReportFiles.Bcs.Models;
...
public sealed class BcsReport
{
    ...
    public BcsReport(ILogger logger, ReportFile file, IDictionary<string, string[]> derivatives)
    {
        File = file;
