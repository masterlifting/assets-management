...
namespace AM.Services.Portfolio.Core.Services.EntityStateService.Steps.Computing.Derivatives
{
    public sealed class DerivativeCalculator : IEntityStepHandler<Derivative>
    {
